...
<project path="" name="Ext.nd - Ext for Notes / Domino" author="Ext.nd LLC" version="Beta 2" copyright="$projectName $version&#xD;&#xA;Copyright(c) 2006, $author.&#xD;&#xA;&#xD;&#xA;http://www.extjs.com/license" output="$project\build" source="True" source-dir="$output\source" minify="true" min-dir="$output\build" doc="False" doc-dir="$output\docs" master="true" master-file="$output\yui-ext.js" zip="true" zip-file="$output\yuo-ext.$version.zip">
  ...
  <file name="domino\CategorizedView.js" path="domino" />
  <file name="domino\CategorizedRSM.js" path="domino" />
  <file name="domino\SearchPlugin.js" path="domino" />

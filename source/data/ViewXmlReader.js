 ...
 * @param {Object} meta Metadata configuration options. This is built for you but if you want
 * to override any of the properties you can do so.
 * @param {Mixed} recordType The definition of the data record type to produce.
 * This can be either a valid Record subclass created with {@link Ext.data.Record#create},
 * or an array of objects with which to call Ext.data.Record.create. See the {@link Ext.data.Record}
...
Ext.extend(Ext.nd.data.ViewXmlReader, Ext.data.XmlReader, {
     ...
     * @return {Object} records A data block which is used by an {@link Ext.nd.ViewStore} as a cache of Ext.data.Records.
     */

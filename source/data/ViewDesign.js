/**
 * Utility class that takes care of making the server calls to get the design information about a view
 */
...
Ext.extend(Ext.nd.data.ViewDesign, Ext.util.Observable, {
    ...
    /**
     * Makes the view?ReadDesign call
     */
    ...
    /**
     * Makes the DXLExporter?OpenAgent call to get extra design information such as toolbar info
     */
    getViewDesignStep2: function(res, req){
        ...
        Ext.each(arColumns, function(item, index, allItems){
            ...
            if (typeof colName != 'undefined') {
                colName = colName.replace(/^$/, '_'); // Ext doesn't like '$' at the beginning like domino automatically will add
    ...
    /**
     * Reads and parses the data from the DXLExporter?OpenAgent call and creates the field definitions for the store
     * and the column definitions for the grid
     */

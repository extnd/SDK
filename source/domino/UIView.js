...
Ext.nd.UIView.prototype = {
  ...
  */
  ...
  dominoRenderer: function(value, cell, row, rowIndex, colIndex,dataStore) {
    ...
    var sCollapseImage = '<img src="' + this.collapseIcon + '" style="vertical-align:bottom; margin-right:4px;"/>';
    var sExpandImage = '<img src="' + this.expandIcon + '" style="vertical-align:bottom; margin-right:4px;"/>';
